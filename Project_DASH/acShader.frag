...
void main()
{
    ...
    // Computing the threshold for red/blue transition based on temperature
    float threshold = mix(radius, -radius, temperatureRatio); // Inverting the range to fill from top
